...
u2 = User.create(:name => 'Teddy', :email => 'teddy@ga.co', :password => 'chicken', :bio => 'I love exploring the local neighbourhood, it is such a beautiful time to be a teddy!', :title => 'Best friend to all', :image => 'https://res.cloudinary.com/drcllkgsn/image/upload/v1603413744/ech235h4uwn6ydsxh7zw.jpg')
u3 = User.create(:name => 'Teacher', :email => 'teacher@ga.co', :password => 'chicken', :bio => 'Do I really have to do this?', :title => 'Best teacher ever. Obviously.', :image => 'https://res.cloudinary.com/drcllkgsn/image/upload/v1603413847/h17cr6ksf9cdc8rooscu.jpg')
u4 = User.create(:name => 'Tony', :email => 'tony@ga.co', :password => 'chicken', :bio => "Tony StarkIron Man. Genius. Billionaire. Philanthropist. Tony Stark's confidence is only matched by his high-flying abilities as the hero called Iron Man." , :title => 'Genius, billionaire, playboy, philanthropist.', :image => 'https://res.cloudinary.com/drcllkgsn/image/upload/v1603413233/murzvu9sorcsylnozvsc.jpg')
...
u6 = User.create(:name => 'Riply', :email => 'riply@ga.co', :password => 'chicken', :bio => 'I was born on October 8th, 2092 at the Olympia colony on Luna. I had one daughter, Amanda Ripley-McClaren. Sometime prior to 2122, I was hired as a Warrant Officer for the Weyland-Yutani commercial hauler USCSS Nostromo.', :title => 'Best Action Hero Ever', :image => 'https://res.cloudinary.com/drcllkgsn/image/upload/v1603340716/vqmsnmkmtah9vjmqrze6.jpg', :admin => true)
...
c5 = Comment.create(:user_id => u8.id, :body => 'Riply I so got your back!')
...
t19 = Tweet.create(:content => 'Alien is a movie where nobody listens to the smart woman, and then they all die except for the smart woman and her cat. Four stars.', :image => 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcT86eDMuO0UNTs0lfUklAPStN3UNLh2a68HFA&usqp=CAU')
